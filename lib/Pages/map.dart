...
import 'package:locker_app/Widget/marker.dart';
              ...
              MarkerLayerOptions(
                markers: [
                  ...
                  Marker(
                      ...
                      builder: (context) {
                        return CustomMarker(Icons.lock_outline, '34');
                      }),
                  Marker(
                      width: 40,
                      height: 40,
                      ...
                      builder: (context) {
                        return CustomMarker(Icons.lock_open, '10');
                      }),
                  Marker(
                      width: 40,
                      height: 40,
                      ...
                      builder: (context) {
                        return CustomMarker(Icons.lock_open, '16');
                      }),
                  Marker(
                      width: 40,
                      height: 40,
                      ...
                      builder: (context) {
                        return CustomMarker(Icons.lock_open, '24');
                      })
                ],
              ),
            ],
